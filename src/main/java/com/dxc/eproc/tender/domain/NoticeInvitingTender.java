...
public class NoticeInvitingTender implements Serializable {
    ...
    public TenderSchedule getId() {
        return this.id;
    }

    public NoticeInvitingTender id(TenderSchedule tenderSchedule) {
        this.setId(tenderSchedule);
        return this;
    }

    public void setId(TenderSchedule tenderSchedule) {
        this.id = tenderSchedule;
    }
