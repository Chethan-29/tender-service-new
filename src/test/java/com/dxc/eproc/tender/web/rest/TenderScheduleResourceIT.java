...
class TenderScheduleResourceIT {
    ...
    public static TenderSchedule createEntity(EntityManager em) {
        ...
        // Add required entity
        NoticeInvitingTender noticeInvitingTender;
        if (TestUtil.findAll(em, NoticeInvitingTender.class).isEmpty()) {
            noticeInvitingTender = NoticeInvitingTenderResourceIT.createEntity(em);
            em.persist(noticeInvitingTender);
            em.flush();
        } else {
            noticeInvitingTender = TestUtil.findAll(em, NoticeInvitingTender.class).get(0);
        }
        tenderSchedule.setNoticeInvitingTender(noticeInvitingTender);
    ...
    public static TenderSchedule createUpdatedEntity(EntityManager em) {
        ...
        NoticeInvitingTender noticeInvitingTender;
        if (TestUtil.findAll(em, NoticeInvitingTender.class).isEmpty()) {
            noticeInvitingTender = NoticeInvitingTenderResourceIT.createUpdatedEntity(em);
            em.persist(noticeInvitingTender);
            em.flush();
        } else {
            noticeInvitingTender = TestUtil.findAll(em, NoticeInvitingTender.class).get(0);
